...
%% UI ImagePanel 
    ...
    Xin.UI.FigPGC(N).hPanelImage = uipanel(...
        ...
        Xin.UI.FigPGC(N).hAxesImage = axes(...
            ...
            'CLimMode',     'Manual',...
            'ALimMode',     'Manual');
        Xin.UI.FigPGC(N).hImage = image(Xin.D.Sys.PointGreyCam(N).DispImg,...
...
%% LOG MSG
msg = [datestr(now, 'yyyy-mm-dd HH:MM:SS.FFF') '\tSetupFigurePointGrey\tSetup the GUI for PointGrey Camera #:',...
    num2str(N) ,'\r\n'];
